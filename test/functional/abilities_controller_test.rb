...
class AbilitiesControllerTest < ActionController::TestCase
  ...
  test "should create ability" do
    assert_difference('Ability.count') do
      post :create, ability: { job_id: @ability.job_id, jp: @ability.jp, kind: @ability.kind, mp: @ability.mp, name: @ability.name, speed: @ability.speed }
    end
  ...
  test "should update ability" do
    put :update, id: @ability, ability: { job_id: @ability.job_id, jp: @ability.jp, kind: @ability.kind, mp: @ability.mp, name: @ability.name, speed: @ability.speed }
    assert_redirected_to ability_path(assigns(:ability))
  end
